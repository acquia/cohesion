...
function hook_cohesion_templates_ENTITY_TYPE_base_hook_alter(&$base_hook) {
  ...
  // This hook is useful when the entity is not responsible for its own rendering
  // For example block_content are rendered by blocks so the hook name as to be altered.
  $base_hook = 'block';
}
