...
use Drupal\cohesion_templates\Form\MenuTemplatesForm;
...
#[ConfigEntityType(
  id: 'cohesion_menu_templates',
  label: new TranslatableMarkup('Menu template'),
  label_collection: new TranslatableMarkup('Menu templates'),
  label_singular: new TranslatableMarkup('menu template'),
  label_plural: new TranslatableMarkup('Menu templates'),
  config_prefix: 'cohesion_menu_templates',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
  ...
  handlers: [
    ...
    'form' => [
      'add' => MenuTemplatesForm::class,
      'edit' => MenuTemplatesForm::class,
      'duplicate' => MenuTemplatesForm::class,
