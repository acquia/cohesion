...
use Drupal\cohesion_templates\Form\MasterTemplateDisableForm;
use Drupal\cohesion_templates\Form\MasterTemplateSetDefaultForm;
use Drupal\cohesion_templates\Form\MasterTemplatesForm;
use Drupal\cohesion_templates\Form\TemplateDeleteForm;
use Drupal\cohesion_templates\Form\TemplateEnableForm;
use Drupal\cohesion_templates\TemplatesListBuilder;
...
#[ConfigEntityType(
  id: 'cohesion_master_templates',
  label: new TranslatableMarkup('Master template'),
  label_collection: new TranslatableMarkup('Master templates'),
  label_singular: new TranslatableMarkup('Master template'),
  label_plural: new TranslatableMarkup('Master templates'),
  config_prefix: 'cohesion_master_templates',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
  ...
  handlers: [
    'list_builder' => TemplatesListBuilder::class,
    'form' => [
      'add' => MasterTemplatesForm::class,
      'edit' => MasterTemplatesForm::class,
      'duplicate' => MasterTemplatesForm::class,
      'delete' => TemplateDeleteForm::class,
      'enable' => TemplateEnableForm::class,
      'disable' => MasterTemplateDisableForm::class,
      'enable-selection' => CohesionEnableSelectionForm::class,
      'disable-selection' => CohesionDisableSelectionForm::class,
      'set_default' => MasterTemplateSetDefaultForm::class,
    ],
    'route_provider' => [
