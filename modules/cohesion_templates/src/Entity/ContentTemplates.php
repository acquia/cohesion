...
use Drupal\cohesion_templates\CohesionContentTemplateHtmlRouteProvider;
use Drupal\cohesion_templates\ContentTemplatesListBuilder;
use Drupal\cohesion_templates\Form\ContentTemplateDisableForm;
use Drupal\cohesion_templates\Form\ContentTemplatesForm;
use Drupal\cohesion_templates\Form\ContentTemplatesSetDefaultForm;
use Drupal\cohesion_templates\Form\TemplateDeleteForm;
use Drupal\cohesion_templates\Form\TemplateEnableForm;
...
#[ConfigEntityType(
  id: 'cohesion_content_templates',
  label: new TranslatableMarkup('Content templates'),
  ...
  handlers: [
    'list_builder' => ContentTemplatesListBuilder::class,
    'form' => [
      'add' => ContentTemplatesForm::class,
      'edit' => ContentTemplatesForm::class,
      'duplicate' => ContentTemplatesForm::class,
      'delete' => TemplateDeleteForm::class,
      'enable' => TemplateEnableForm::class,
      'disable' => ContentTemplateDisableForm::class,
      'enable-selection' => CohesionEnableSelectionForm::class,
      'disable-selection' => CohesionDisableSelectionForm::class,
      'set_default' => ContentTemplatesSetDefaultForm::class,
    ],
    'route_provider' => [
      'html' => CohesionContentTemplateHtmlRouteProvider::class,
    ],
  ],
  links: [
    'edit-form' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/edit',
    'add-form' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{bundle}/add',
    'delete-form' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/delete',
    'collection' => '/admin/cohesion/templates/content_templates/{content_entity_type}',
    'duplicate-form' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/duplicate',
    'disable' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/disable',
    'enable' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/enable',
    'enable-selection' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/enable-selection',
    'disable-selection' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/disable-selection',
    'set-default-form' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/set_default',
    'in-use' => '/admin/cohesion/templates/content_templates/{content_entity_type}/{cohesion_content_templates}/in_use',
  ],
  admin_permission: 'administer content templates',
  label_count: [
    'singular' => '@count content template',
