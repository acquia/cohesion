...
use Drupal\cohesion_templates\Form\ViewTemplatesForm;
...
#[ConfigEntityType(
  id: 'cohesion_view_templates',
  label: new TranslatableMarkup('View template'),
  label_collection: new TranslatableMarkup('View templates'),
  label_singular: new TranslatableMarkup('View template'),
  label_plural: new TranslatableMarkup('View templates'),
  config_prefix: 'cohesion_view_templates',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
  ...
  handlers: [
    ...
    'form' => [
      'add' => ViewTemplatesForm::class,
      'edit' => ViewTemplatesForm::class,
      'duplicate' => ViewTemplatesForm::class,
