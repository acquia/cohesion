...
class TwigExtension extends \Twig_Extension {
  ...
  public function frontendBuilderDropzone($_context, $element_uuid, $startStop) {
    ...
    $permission = ["access contextual links", "access components"];
    if ($this->isFrontendEditor() && !isset($_context['component_content']) && !isset($_context['hideContextualLinks']) && !isset($_context['isPreview']) && $this->hasDrupalPermission($permission)) {
      return [
        '#type' => 'container',
        '#attributes' => [
