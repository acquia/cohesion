...
#[FieldType(
  ...
  label: new TranslatableMarkup("Template selector"),
  description: new TranslatableMarkup("Template selector"),
...
class CohesionTemplateSelectorFieldItem extends FieldItemBase implements FieldItemInterface {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['value'] = DataDefinition::create('string')->setLabel(t('Template'));
    return $properties;
  }
