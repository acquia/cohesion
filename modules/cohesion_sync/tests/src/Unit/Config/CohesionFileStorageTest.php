...
class CohesionFileStorageTest extends UnitTestCase {
   ...
   * @return array
   */
  public static function dataGetFileFixtures(): array {
    ...
    $expectedFiles = self::readMetadata($directory);
   ...
   * @return array
   */
  protected static function readMetadata(string $directory): array {
    $metadata = [];
