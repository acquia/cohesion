    ...
    foreach ($in_use_list as $uuid => $type) {
      ...
      foreach ($cohesionLayoutEntities as $cohesionLayoutEntity) {
        if ($this->hasDefinedContentForRemovedComponentField(
          ...
          $source_component_config['json_values'],
          $target_component_config['id']
        )) {
          ...
          if (!isset($broken_entities[$source_component_config['id']]['affected_entities'][$affected_entity->uuid()])) {
            $broken_entities[$source_component_config['id']]['affected_entities'][$affected_entity->uuid()] = [
              'type' => $type,
