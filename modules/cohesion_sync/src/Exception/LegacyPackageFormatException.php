...
class LegacyPackageFormatException extends \Exception {
  ...
  const ERROR_MESSAGE = 'File with legacy package format ("%s") detected. Legacy package format is not supported by this command. For more information refer to the documentation page: https://docs.acquia.com/drupal-starter-kits/add-ons/site-studio/deprecating-legacy-package-system';
