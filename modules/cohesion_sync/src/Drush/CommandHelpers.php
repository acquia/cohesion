...
final class CommandHelpers {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entityTypeManager, ConfigFactoryInterface $configFactory, PackagerManager $packagerManager, EntityRepository $entityRepository, State $state, FileSystem $fileSystem, UuidInterface $uuid) {
