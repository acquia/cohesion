...
class CohesionSyncCommands extends DrushCommands {
  ...
  public function export(array $options = ['filename-prefix' => NULL]) {
    ...
    $this->warn('You are using a deprecated package export command which will be removed in a future version of Site Studio. For more information refer to documentation at https://docs.acquia.com/drupal-starter-kits/add-ons/site-studio/deprecating-legacy-package-system');
  ...
  public function import(
    ...
    $this->warn('You are using a deprecated package import command which will be removed in a future version of Site Studio. For more information refer to documentation at https://docs.acquia.com/drupal-starter-kits/add-ons/site-studio/deprecating-legacy-package-system');
