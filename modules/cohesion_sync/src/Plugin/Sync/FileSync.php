...
use Drupal\cohesion_sync\Attribute\Sync;
...
#[Sync(
  id: "file_sync",
  name: new TranslatableMarkup("File entity and content sync"),
...
class FileSync extends SyncPluginBase {
   ...
   *   The file system service.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityRepositoryInterface $entity_repository, EntityTypeManagerInterface $entity_type_manager, TranslationInterface $string_translation, FileSystemInterface $file_system) {
