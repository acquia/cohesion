...
class DX8Resource extends ResourceBase {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, array $serializer_formats, LoggerInterface $logger, EntityTypeManagerInterface $entity_type_manager, KillSwitch $cache_kill_switch, EntityRepositoryInterface $entityRepository, PackagerManager $packager_manager) {
