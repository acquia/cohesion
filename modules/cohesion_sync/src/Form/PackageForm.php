...
class PackageForm extends EntityForm {
  ...
  public static function create(ContainerInterface $container) {
    return new static($container->get('plugin.manager.usage.processor'));
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['details'] = [
      ...
      '#open' => 'panel-open',
      '#help_link' => \Drupal::service('cohesion.support_url')->getSupportUrlPrefix() . 'package-edit-details',
    ];
    ...
    $form['excluded'] = [
      ...
      '#help_link' => \Drupal::service('cohesion.support_url')->getSupportUrlPrefix() . 'package-edit-excluded',
    ];
    ...
    $form_requirements = [
      ...
      '#open' => 'panel-open',
      '#help_link' => \Drupal::service('cohesion.support_url')->getSupportUrlPrefix() . 'package-edit-requirements',
    ];
    ...
    $form_contents = [
      ...
      '#open' => 'panel-open',
      '#help_link' => \Drupal::service('cohesion.support_url')->getSupportUrlPrefix() . 'package-edit-contents',
    ];
