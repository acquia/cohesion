...
abstract class ExportFormBase extends ConfigFormBase {
  ...
  protected function showNoEntityTypesMessage() {
    drupal_set_message($this->t('Entities available for export have not been defined. <a href="/admin/cohesion/sync/export_settings">Click here to go to the export settings.</a>'), 'warning');
  }
