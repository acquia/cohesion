...
#[ConfigEntityType(
  id: 'custom_style_type',
  label: new TranslatableMarkup('Custom style type'),
  label_singular: new TranslatableMarkup('Custom style type'),
  label_plural: new TranslatableMarkup('Custom style types'),
  config_prefix: 'cohesion_custom_style_type',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
