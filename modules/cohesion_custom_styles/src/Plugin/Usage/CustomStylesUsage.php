...
#[Usage(
  ...
  name: new TranslatableMarkup("Custom styles usage"),
...
class CustomStylesUsage extends UsagePluginBase {
  ...
  // Use a regex to scan the JSON blob for usages for custom styles.
  ...
  public function scanForInstancesOfThisType($data, EntityInterface $entity) {
    ...
    // Get all the custom styles used.
