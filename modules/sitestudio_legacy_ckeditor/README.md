...
The core Acquia Site Studio module can be found at [https://github.com/acquia/cohesion](https://github.com/acquia/cohesion) - for full details on product setup and installation please refer to the [documentation](https://docs.acquia.com/).
...
Further documentation for Site Studio Legacy CKEditor is available [here](https://docs.acquia.com/drupal-starter-kits/add-ons/site-studio/docs/upgrading/ckeditor-4-ckeditor-5).
