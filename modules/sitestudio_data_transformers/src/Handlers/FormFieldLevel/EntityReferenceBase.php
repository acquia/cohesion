...
/**
 * Entity reference handling in Site Studio form fields.
 */
abstract class EntityReferenceBase extends FieldHandlerBase {
  ...
  public function getData(Element $formField, ElementModel $elementModel): array {
    $data = parent::getData($formField, $elementModel);
