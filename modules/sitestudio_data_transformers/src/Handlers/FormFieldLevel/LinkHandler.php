 ...
 */
class LinkHandler extends EntityReferenceBase implements FormFieldLevelHandlerInterface {

  const ID = 'form-link';
  const MAP = '/maps/field/link.map.yml';
  const SCHEMA = '/maps/field/link.schema.json';
