...
use Drupal\cohesion_elements\Annotation\CustomElement as CustomElementAnnotation;
use Drupal\cohesion_elements\Attribute\CustomElement;
...
class CustomElementPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      'Plugin/CustomElement',
      $namespaces,
      $module_handler,
      CustomElementPluginInterface::class,
      CustomElement::class,
      CustomElementAnnotation::class
    );
