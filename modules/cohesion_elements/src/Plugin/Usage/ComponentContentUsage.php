...
#[Usage(
  ...
  name: new TranslatableMarkup("Component content usage"),
...
class ComponentContentUsage extends UsagePluginBase {
   ...
   * @return void
   */
  private function scanForComponentContent($array): void {
    foreach ($array as $key => $item) {
      if ($key === 'entity' && isset($item['entityType'], $item['entityUUID']) && $item['entityType'] === 'component_content') {
        $this->entities[] = [
