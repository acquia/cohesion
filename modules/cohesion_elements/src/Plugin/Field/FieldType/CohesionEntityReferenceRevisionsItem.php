 ...
 *   be referenced. May be set to a single bundle, or to an array of
 *   allowed bundles.
 */
#[FieldType(
  id: "cohesion_entity_reference_revisions",
  label: new TranslatableMarkup("Site Studio Entity reference revisions"),
  description: new TranslatableMarkup("An entity field containing a CohesionLayout entity reference to a specific revision."),
