  ...
  public function getComponentContents(Request $request) {
    ...
    foreach ($component_contents as $component_content) {
      ...
      if ($component_field) {
        ...
        $tag_entity = !empty($component->getTag()) ? $component->getTagEntity() : [];
        ...
        $data[$component->id()]['children'][] = [
          ...
          'tag' => $tag_entity ? Component::getTagDetails($tag_entity) : [],
    ...
    if (is_array($uids)) {
      foreach ($uids as $uid) {
        ...
        if ($component_content) {
          ...
          $tag_entity = !empty($component_content->getComponent()->tag) ? $component_content->getComponent()->getTagEntity() : [];
