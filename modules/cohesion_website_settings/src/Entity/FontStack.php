...
#[ConfigEntityType(
  id: 'cohesion_font_stack',
  label: new TranslatableMarkup('Font stack'),
  label_collection: new TranslatableMarkup('Font stacks'),
  label_singular: new TranslatableMarkup('Font stack'),
  label_plural: new TranslatableMarkup('Font stacks'),
  config_prefix: 'cohesion_font_stack',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
