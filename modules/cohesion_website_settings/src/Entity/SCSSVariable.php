...
#[ConfigEntityType(
  id: 'cohesion_scss_variable',
  label: new TranslatableMarkup('SCSS Variable'),
  label_collection: new TranslatableMarkup('SCSS Variables'),
  label_singular: new TranslatableMarkup('SCSS Variable'),
  label_plural: new TranslatableMarkup('SCSS Variables'),
  config_prefix: 'cohesion_scss_variable',
  entity_keys: [
    'id' => 'id',
    'value' => 'value',
