...
#[ConfigEntityType(
  id: 'cohesion_font_library',
  label: new TranslatableMarkup('Font library'),
  label_collection: new TranslatableMarkup('Font libraries'),
  label_singular: new TranslatableMarkup('Font library'),
  label_plural: new TranslatableMarkup('Font libraries'),
  config_prefix: 'cohesion_font_library',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
