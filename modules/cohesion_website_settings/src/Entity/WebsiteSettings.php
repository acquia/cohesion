...
use Drupal\cohesion_website_settings\Form\WebsiteSettingsForm;
use Drupal\cohesion_website_settings\WebsiteSettingsListBuilder;
...
#[ConfigEntityType(
  id: 'cohesion_website_settings',
  label: new TranslatableMarkup('Website settings'),
  label_collection: new TranslatableMarkup('Website settings'),
  label_singular: new TranslatableMarkup('Website setting'),
  label_plural: new TranslatableMarkup('Website settings'),
  config_prefix: 'cohesion_website_settings',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
  ...
  handlers: [
    'list_builder' => WebsiteSettingsListBuilder::class,
    'form' => [
      'edit' => WebsiteSettingsForm::class,
    ],
    'route_provider' => [
  ...
  links: [
    'edit-form' => '/admin/cohesion/cohesion_website_settings/{cohesion_website_settings}/edit',
    'collection' => '/admin/cohesion/cohesion_website_settings',
  ],
  admin_permission: 'administer website settings',
  label_count: [
...
class WebsiteSettings extends WebsiteSettingsEntityBase implements CohesionSettingsInterface {
  ...
  public function postSave(EntityStorageInterface $storage, $update = TRUE) {
    ...
    if ($this->status() && $this->isModified() && $this->callApi) {
      $this->process();
    }
