...
#[ConfigEntityType(
  id: 'cohesion_style_guide_manager',
  label: new TranslatableMarkup('Style guide manager'),
  label_collection: new TranslatableMarkup('Style guides manager'),
  label_singular: new TranslatableMarkup('Style guide manager'),
  label_plural: new TranslatableMarkup('Style guides manager'),
  config_prefix: 'cohesion_style_guide_manager',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
