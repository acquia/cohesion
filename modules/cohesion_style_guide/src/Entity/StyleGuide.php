...
use Drupal\cohesion_style_guide\Form\StyleGuideDeleteForm;
use Drupal\cohesion_style_guide\Form\StyleGuideDisableForm;
use Drupal\cohesion_style_guide\Form\StyleGuideEnableForm;
use Drupal\cohesion_style_guide\Form\StyleGuideForm;
use Drupal\cohesion_style_guide\StyleGuideListBuilder;
...
#[ConfigEntityType(
  ...
  label_collection: new TranslatableMarkup('Style guides'),
  label_singular: new TranslatableMarkup('Style guide'),
  label_plural: new TranslatableMarkup('Style guides'),
  config_prefix: 'cohesion_style_guide',
  entity_keys: [
    'id' => 'id',
    'label' => 'label',
  ...
  handlers: [
    'list_builder' => StyleGuideListBuilder::class,
    'form' => [
      'default' => StyleGuideForm::class,
      'add' => StyleGuideForm::class,
      'edit' => StyleGuideForm::class,
      'duplicate' => StyleGuideForm::class,
      'delete' => StyleGuideDeleteForm::class,
      'disable' => StyleGuideDisableForm::class,
      'enable' => StyleGuideEnableForm::class,
    ],
    'route_provider' => [
  ...
  links: [
    'edit-form' => '/admin/cohesion/style_guides/{cohesion_style_guide}/edit',
    'add-form' => '/admin/cohesion/style_guides/add',
    'delete-form' => '/admin/cohesion/style_guides/{cohesion_style_guide}/delete',
    'collection' => '/admin/cohesion/style_guides',
    'duplicate-form' => '/admin/cohesion/style_guides/{cohesion_style_guide}/duplicate',
    'in-use' => '/admin/cohesion/style_guides/{cohesion_style_guide}/in_use',
    'disable' => '/admin/cohesion/style_guides/{cohesion_style_guide}/disable',
    'enable' => '/admin/cohesion/style_guides/{cohesion_style_guide}/enable',
  ],
  admin_permission: 'administer style_guide',
  label_count: [
