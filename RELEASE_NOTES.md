...
### Inline quick edit not loading for components

#### What is it?

Fixes a bug where the inline quick edit was not loading for components on a site where the page didn't have a translation.

#### What impact will there be?

The component inline edit form will now load correctly if the site has a translation or not.
...
Additional information about the new commands is available [here](https://sitestudiodocs.acquia.com/6.8/user-guide/sync-package-export-and-import)
