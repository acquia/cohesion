...
Site Studio now includes comprehensive CSS Grid support in the Style Builder, allowing you to create sophisticated grid-based layouts directly through the visual interface. This feature provides:
...
4. **Complete Testing Coverage**: Comprehensive end-to-end test suite validates all grid functionality across different scenarios.

#### What impact will there be?

- New CSS Grid layout options available in the Style Builder interface
- Enhanced layout capabilities for creating complex, responsive designs
- Improved form validation for grid-related properties
- Better user experience with visual grid controls
...
The cleanup command and cron job permanently delete orphaned revision data. Always run with `--dry-run` first to review what will be deleted. Consider backing up your database before running the initial cleanup.
