...
### React app dependencies reporting high severity vulnerabilities

#### What is it?

Fixes an issue where outdated dependencies in the Site Studio React app were reported as high severity vulnerabilities by npm audit.

#### What impact will there be?

The Site Studio React app now uses updated dependency versions and patched transitive dependencies, reducing security risk without changing the existing Site Studio UI behavior.
