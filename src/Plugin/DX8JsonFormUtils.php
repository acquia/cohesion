...
class DX8JsonFormUtils {
   ...
   * @return array
   */
  private function getElementFieldGroupSelectOptions($form_data = []): array {
    $results = [];
    if ($form_data) {
   ...
   * @return array
   */
  private function getElementFieldGroups($options = []): array {
    $data = [];
   ...
   * @return array
   */
  public function loadDX8FormSelectItems(): array {
   ...
   * @return array
   */
  public function stylesFieldGroupSelectOptions($results = []): array {
    $data = [];
   ...
   * @return array
   */
  public function stylesFieldGroups($values = []): array {
    $data = [];
   ...
   * @return array
   */
  public function getCvFieldGroups($values = []): array {
    $data = [];
   ...
   * @return array
   */
  public function cvFieldGroupSelectOptions($results = []): array {
    $data = [];
    foreach ($results as $result) {
   ...
   * @return array
   */
  public function elementToElementPropertyMapper(): array {
    ...
    $element_to_option_mapper = array_map(function ($value) {
      ...
      return $element_id;
    }, $static_assets->get('api-urls')['urls']['property_group_options']);
   ...
   */
  public function elementPropertyOptions($data = []): array {
    $results = [];
    if ($data) {
   ...
   * @return array
   */
  public function elementsGroupOptions(): array {
    $results = [];
    ...
    $excludes = \Drupal::keyValue('cohesion.assets.static_assets')
      ->get('component-select-exclude')['items'];
