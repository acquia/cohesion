...
#[Usage(
  id: "node_usage",
  name: new TranslatableMarkup("Node usage"),
  entity_type: "node",
  scannable: TRUE,
  scan_same_type: TRUE,
  group_key: FALSE,
...
class NodeUsage extends FieldableContentEntityUsageBase {
   ...
   */
  protected function scanCanvasForCustomComponents(array $canvas, array &$entities): void {
   ...
   *   The entities array to populate.
   */
  protected function scanArrayRecursively(array $data, array &$entities): void {
