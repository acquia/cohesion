...
class TemplatesApi extends ApiPluginBase {
  ...
  public function prepareData($attach_css = TRUE) {
    ...
    // Adds information on global JS libraries that are enabled.
    $this->data->settings->globalLibs = $this->cohesionFrontEndSettings->getRawData();
