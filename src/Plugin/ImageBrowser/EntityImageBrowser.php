...
use Drupal\cohesion\Attribute\ImageBrowser;
...
#[ImageBrowser(
  ...
  name: new TranslatableMarkup("Entity Browser"),
...
class EntityImageBrowser extends ImageBrowserPluginBase {
  ...
  public function buildForm(FormStateInterface &$form_state, $browser_type, $config_object) {
    ...
    // Set the media entity browser to be default (if it's available).
