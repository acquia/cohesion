...
final class DX8CommandHelpers {
  ...
  /**
   * Find orphaned cohesion layout revisions from any entity type using
   * layout canvas.
   *
   * @return array
   *   Array of orphaned revision IDs.
   */
  public static function findOrphanedRevisions() {
    return \Drupal::service('cohesion.layout_revision_manager')->findOrphanedRevisions();
  }

  /**
   * Clean up orphaned cohesion layout revisions from any entity type using
   * layout canvas.
   *
   * @param bool $dry_run
   ...
   */
  public static function cleanupOrphans($dry_run = FALSE) {
    return \Drupal::service('cohesion.layout_revision_manager')->cleanupOrphans($dry_run, 'drush');
  }
