 ...
 */
#[FormElement('cohesionfield')]
class CohesionField extends FormElementBase {
  ...
  public static function processCohesion(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    if (isset($element['#token_browser'])) {
      ...
      // Render to populate BubbleableMetadata attachments.
      // Note: render() here is used for side effects within a form processing
      // callback. The deprecated use is for top-level content rendering,
      // which this is not.
