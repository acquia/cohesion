...
abstract class CohesionConfigEntityBase extends ConfigEntityBase implements CohesionSettingsInterface, EntityUpdateInterface {
  ...
  public function postSave(EntityStorageInterface $storage, $update = TRUE) {
    ...
    // Update the cohesion_usage table for this entity.
  ...
  public function getInUseMarkup() {
    ...
    return \Drupal::service('renderer')->renderRoot($markup);
  }
  ...
  public function calculateDependencies() {
    ...
    foreach ($dependencies as $dependency) {
      ...
      if (!is_string($dependency_type) ||
        $dependency_type === '' ||
        !\Drupal::entityTypeManager()->hasDefinition($dependency_type)
      ) {
        continue;
      }
      $plugin = \Drupal::entityTypeManager()->getDefinition($dependency_type);
      $entity = \Drupal::entityTypeManager()
        ->getStorage($dependency_type)
