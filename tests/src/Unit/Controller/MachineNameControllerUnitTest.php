...
class MachineNameControllerUnitTest extends UnitTestCase {
   ...
   */
  public function testEntityDoesNotExistNoTruncation(): void {
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityDoesNotExistTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([]));
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityExistsNoTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'existing_entity',
    ]));
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityExistsMultipleNoTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'existing_entity',
      'existing_entity_0',
      'existing_entity_1',
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityExistsTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'this_entit',
    ]));
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityExistsMultipleTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'this_entit',
      'this_ent_0',
      'this_ent_1',
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityNumericSuffixButDoesNotExist(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([]));
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityNumericSuffixButSeriesDoesNotExist(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'this_ent_3',
    ]));
   ...
   * @covers \Drupal\cohesion\Controller\MachineNameController::getUniqueEntityId
   */
  public function testEntityMatchesThisEntityNoTruncation(): void {
    $this->mockUnit->setStorage(new MachineNameStorageMock([
      'very_short',
    ]));
