...
class SettingsEndpointUtilsTest extends UnitTestCase {
  ...
  public function setUp(): void {
    ...
    $keyValueFactory = $this->createMock('\Drupal\Core\KeyValueStore\KeyValueFactoryInterface');
    $currentUser = $this->createMock('\Drupal\Core\Session\AccountInterface');
    $libraryDiscovery = $this->createMock('\Drupal\Core\Asset\LibraryDiscoveryInterface');
    $fileSystem = $this->createMock('\Drupal\Core\File\FileSystemInterface');
    $apiClient = $this->createMock('stdClass');
    ...
    $this->unit = new SettingsEndpointUtils(
      $cohesionApiElementStorage,
      $this->entityTypeManager,
      $entity_group_manager,
      $httpKernel,
      $keyValueFactory,
      $currentUser,
      $libraryDiscovery,
   ...
   */
  public function testGetColorsList($colors_data, $item, $expected): void {
   ...
   *   Data set
   */
  public static function getColorsListDataProvider(): array {
    $test_data = [];
