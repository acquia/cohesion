 ...
 */
class PostRebuildEventSubscriberMock extends PostRebuildEvent implements EventSubscriberInterface {

  public function __construct() {
    // Call parent with dummy values - this mock doesn't need real data
 ...
 */
class PostRebuildEventUnitTest extends UnitTestCase {
