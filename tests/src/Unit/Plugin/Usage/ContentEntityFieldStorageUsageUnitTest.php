...
use Drupal\Tests\cohesion\Unit\UsagePluginBaseUnitTestCase;
 ...
 * @group Cohesion
 */
class ContentEntityFieldStorageUsageUnitTest extends UsagePluginBaseUnitTestCase {
   ...
   */
  public function testScanForInstancesOfThisType(): void {
