...
/**
 * Mock of _0032EntityUpdate with overridable loadComponentContent.
 */
class _0032EntityUpdateMock extends _0032EntityUpdate {

  /**
   * {@inheritdoc}
   */
  protected function loadComponentContent($cc_id) {
    // Return a mock object with uuid() method for unit testing.
    return new class {
      public function uuid() {
        return 'b167bbba-52ed-4774-921e-aa4bdb9eb421';
      }
    };
  }
 ...
 * @group Cohesion
 */
class _0032EntityUpdateUnitTest extends EntityUpdateUnitTestCase {
  ...
  public function setUp():void {
    $this->unit = new _0032EntityUpdateMock([], NULL, NULL);
  }
