...
class CohesionUtilsTest extends UnitTestCase {
   ...
   */
  public function testPathRendererMediaWithoutMediaLinkSetting() {
   ...
   */
  public function testPathRendererMediaWithMediaLinkSetting() {
   ...
   */
  public function testPathRendererAcquiaDamMedia() {
   ...
   */
  public function testPathRendererMediaNotFound() {
    $mediaStorage = $this->prophesize(EntityStorageInterface::class);
   ...
   */
  public function apiKeysConfiguredDataProvider(): array {
    return [
   ...
   */
  public function testApiKeysConfigured($apiKey, $orgKey, $expected) {
    $config = $this->prophesize(\Drupal\Core\Config\ImmutableConfig::class);
