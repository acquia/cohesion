...
class XssComponentFieldValuesTest extends UnitTestCase {
  ...
  public function setup(): void {
    ...
    $this->cohUtils = new CohesionUtils($theme_handler, $theme_manager, $entity_type_manager, $language_manager, $logger_factory, $config_factory, $module_handler, $token);
  }
   ...
   */
  public function testProcessFieldValues($element_data, $model, $fieldValue, $expected): void {
   ...
   * @return array
   */
  public static function processFieldValuesDataProvider(): array {
    $data = [];
